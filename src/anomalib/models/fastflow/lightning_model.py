...
class Fastflow(AnomalyModule):
    ...
    Args:
        ...
        anomaly_maps_size (tuple[int, int] | None): Size of output anomaly.
    """
    ...
    def __init__(
        ...
        anomaly_maps_size: tuple[int, int] | None = None,
    ) -> None:
        super().__init__()
        ...
        self.model = FastflowModel(
            ...
            anomaly_maps_size=anomaly_maps_size,
        )
...
class FastflowLightning(Fastflow):
    ...
    def __init__(self, hparams: DictConfig | ListConfig) -> None:
        ...
        if "ensemble" in hparams:
            anomaly_maps_size = input_size
        else:
            anomaly_maps_size = hparams.dataset.image_size
